...
CREATE TABLE Province(
        ...
        IdPays      Int NOT NULL
	,CONSTRAINT Province_PK PRIMARY KEY (IdProvince)
)ENGINE=InnoDB;
...
CREATE TABLE RegionAdm(
        IdRegionAdm Int  Auto_increment  NOT NULL ,
        RegionAdm   Varchar (50) NOT NULL ,
        IdProvince  Int NOT NULL
	,CONSTRAINT RegionAdm_PK PRIMARY KEY (IdRegionAdm)
)ENGINE=InnoDB;
...
ALTER TABLE RegionAdm
	ADD CONSTRAINT RegionAdm_Province0_FK
	FOREIGN KEY (IdProvince)
	REFERENCES Province(IdProvince);

ALTER TABLE Ville
	ADD CONSTRAINT Ville_RegionAdm0_FK
	FOREIGN KEY (IdRegionAdm)
	REFERENCES RegionAdm(IdRegionAdm);
