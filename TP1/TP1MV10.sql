...
CREATE TABLE Province(
        IdProvence  Int  Auto_increment  NOT NULL ,
        NomProvince Varchar (50) NOT NULL ,
        IdPays      Int NOT NULL
	,CONSTRAINT Province_PK PRIMARY KEY (IdProvence)
)ENGINE=InnoDB;
...
ALTER TABLE RegionAdmin
	...
	FOREIGN KEY (IdProvence)
	REFERENCES Province(IdProvence);
